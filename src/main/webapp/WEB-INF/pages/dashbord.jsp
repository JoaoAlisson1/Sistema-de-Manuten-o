...
<div style="position: absolute; top: 10px; left: 10px; z-index: 10">
    <h2 class="text-white">AeroCare</h2>
</div>
<main>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
                        <div class="page-title  home text-center">
                                  <span class="heading-page">  Bem-vindo ao AeroCare!
                                  </span>
                            <p class="mt20 text-white">Seu sistema inteligente de gestão e manutenção aeronáutica.</p>
                        </div>
                        ...
                        <div class="hexagon-menu clear">
                            ...
                            <div class="hexagon-item">
                                ...
                                <a  class="hex-content" href="mecanicos">
                                            <span class="hex-content-inner">
                                                ...
                                                <span class="title">Mecânicos</span>
                                            </span>
                                    <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M86.60254037844386 0L173.20508075688772 50L173.20508075688772 150L86.60254037844386 200L0 150L0 50Z" fill="#1e2530"></path></svg>
                                </a>
                            </div>
                            ...
                            <div class="hexagon-item">
                                ...
                                <a  class="hex-content" href="usuario">
                                            <span class="hex-content-inner">
                                                <span class="icon">
                                                    <img src="imagens/profile-user.png" alt="icone usuario">
                                                </span>
